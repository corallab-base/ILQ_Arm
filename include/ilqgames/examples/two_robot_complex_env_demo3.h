...
class TwoRobotComplexEnvDemo3 : public TopDownRobRenderableProblem {
public:
    ~TwoRobotComplexEnvDemo3() {}
    TwoRobotComplexEnvDemo3() : TopDownRobRenderableProblem() {}
