#ifndef ILQGAMES_EXAMPLES_TWO_ROBOT_CROSS_EASY_EXAMPLE_H
#define ILQGAMES_EXAMPLES_TWO_ROBOT_CROSS_EASY_EXAMPLE_H
...
class TwoRobotCrossEasyExample : public TopDownRobRenderableProblem {
public:
    ~TwoRobotCrossEasyExample() {}
    TwoRobotCrossEasyExample() : TopDownRobRenderableProblem() {}
...
};    // class TwoRobotCrossEasyExample
