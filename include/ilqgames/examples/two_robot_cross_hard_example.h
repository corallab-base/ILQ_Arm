#ifndef ILQGAMES_EXAMPLES_TWO_ROBOT_CROSS_HARD_EXAMPLE_H
#define ILQGAMES_EXAMPLES_TWO_ROBOT_CROSS_HARD_EXAMPLE_H
...
class TwoRobotCrossHardExample : public TopDownRobRenderableProblem {
 public:
  ~TwoRobotCrossHardExample() {}
  TwoRobotCrossHardExample() : TopDownRobRenderableProblem() {}
...
};  // class TwoRobotCrossHardExample
