#ifndef ILQGAMES_EXAMPLES_THREE_ROBOT_DEMO2_H
#define ILQGAMES_EXAMPLES_THREE_ROBOT_DEMO2_H
...
class ThreeRobotDemo2 : public TopDownRobRenderableProblem {
 public:
  ~ThreeRobotDemo2() {}
  ThreeRobotDemo2() : TopDownRobRenderableProblem() {}
