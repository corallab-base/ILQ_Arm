...
class TwoRobotComplexEnvDemo1 : public TopDownRobRenderableProblem {
public:
    ~TwoRobotComplexEnvDemo1() {}
    TwoRobotComplexEnvDemo1() : TopDownRobRenderableProblem() {}
