...
class TwoRobotComplexEnvDemo4 : public TopDownRobRenderableProblem {
public:
    ~TwoRobotComplexEnvDemo4() {}
    TwoRobotComplexEnvDemo4() : TopDownRobRenderableProblem() {}
